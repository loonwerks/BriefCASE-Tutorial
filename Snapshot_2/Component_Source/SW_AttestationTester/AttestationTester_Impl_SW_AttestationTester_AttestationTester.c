...
Unit HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_initialise_(STACK_FRAME_ONLY) {
  ...
  // byte_array_default(SF t0, numBits_HAMR_Data_Types_AttestationResponseMsg_Impl, numBytes_HAMR_Data_Types_AttestationResponseMsg_Impl);
  // api_put_AttestationResponse__HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester(SF numBits_HAMR_Data_Types_AttestationResponseMsg_Impl, t0);
...
Unit HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_timeTriggered_(STACK_FRAME_ONLY) {
  ...
  if(api_get_AttestationRequest__HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester(SF &t0_numBits, t0)) {
    // sanity check
    sfAssert(SF (Z) t0_numBits == numBits_HAMR_Data_Types_AttestationRequestMsg_Impl, "numBits received does not match expected");
    ...
    // byte_array_string(SF (String) &AttestationRequest_str, t0, numBytes_HAMR_Data_Types_AttestationRequestMsg_Impl);
