...
Unit HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_initialise_(STACK_FRAME_ONLY) {
  ...
  // api_put_AttestationRequest__HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager(SF numBits_HAMR_Data_Types_AttestationRequestMsg_Impl, t0);

  // uint8_t t1[numBytes_HAMR_Data_Types_AllowList_Impl];
  // byte_array_default(SF t1, numBits_HAMR_Data_Types_AllowList_Impl, numBytes_HAMR_Data_Types_AllowList_Impl);
  // api_put_TrustedIds__HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager(SF numBits_HAMR_Data_Types_AllowList_Impl, t1);
...
Unit HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_timeTriggered_(STACK_FRAME_ONLY) {
  ...
  if(api_get_AttestationResponse__HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager(SF &t0_numBits, t0)) {
    ...
    // byte_array_string(SF (String) &AttestationResponse_str, t0, numBytes_HAMR_Data_Types_AttestationResponseMsg_Impl);
    // api_logInfo__HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager(SF (String) &AttestationResponse_str);
  }

  static uint32_t t1[numBits_HAMR_Data_Types_AllowList_Impl/4] = {1, 0, 0, 0};
  api_put_TrustedIds__HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager(SF numBits_HAMR_Data_Types_AllowList_Impl, (uint8_t *)t1);
