...
Unit HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_initialise_(STACK_FRAME_ONLY) {
  ...
  // byte_array_default(SF t0, numBits_HAMR_Data_Types_RF_Msg_Impl, numBytes_HAMR_Data_Types_RF_Msg_Impl);
  // api_put_MissionCommand_out__HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate(SF numBits_HAMR_Data_Types_RF_Msg_Impl, t0);
...
Unit HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_timeTriggered_(STACK_FRAME_ONLY) {
  DeclNewStackFrame(caller, "AttestationGate_Impl_SW_AttestationGate_AttestationGate.c", "", "HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_timeTriggered_", 0);
  ...
  if(api_get_TrustedIds__HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate(SF &t1_numBits, t1)) {
    // sanity check
    sfAssert(SF (Z) t1_numBits == numBits_HAMR_Data_Types_AllowList_Impl, "numBits received does not match expected");

    // DeclNewString(TrustedIds_str);
    // String__append(SF (String) &TrustedIds_str, string("Received on TrustedIds: "));
    // byte_array_string(SF (String) &TrustedIds_str, t1, numBytes_HAMR_Data_Types_AllowList_Impl);
  ...
  if(api_get_MissionCommand_in__HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate(SF &t0_numBits, t0)) {
    ...
    // byte_array_string(SF (String) &MissionCommand_in_str, t0, numBytes_HAMR_Data_Types_RF_Msg_Impl);
    // api_logInfo__HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate(SF (String) &MissionCommand_in_str);
    if (isTrusted(t0, t1)) {
      printf("GATE PASS\n");
      api_put_MissionCommand_out__HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate(SF t0_numBits, t0);
    } else {
      fprintf(stderr, "GATE BLOCK\n");
    }
