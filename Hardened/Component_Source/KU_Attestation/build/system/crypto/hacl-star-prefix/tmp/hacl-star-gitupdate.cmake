...
execute_process(
  COMMAND "/usr/bin/git" show-ref "50db8e4147258a5dc8e18c940c1b045ce5558723"
  WORKING_DIRECTORY "/home/vagrant/workspace/Shapshot_9/Component_Source/KU_Attestation/build/system/crypto/hacl-star"
...
if("${show_ref_output}" MATCHES "refs/remotes/50db8e4147258a5dc8e18c940c1b045ce5558723")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "50db8e4147258a5dc8e18c940c1b045ce5558723")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "50db8e4147258a5dc8e18c940c1b045ce5558723")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/project-everest/hacl-star/'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/vagrant/workspace/Shapshot_9/Component_Source/KU_Attestation/build/system/crypto/hacl-star'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/vagrant/workspace/Shapshot_9/Component_Source/KU_Attestation/build/system/crypto/hacl-star'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
