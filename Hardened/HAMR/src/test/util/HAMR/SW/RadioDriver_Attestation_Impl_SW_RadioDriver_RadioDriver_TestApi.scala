...
abstract class RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_TestApi extends BridgeTestSuite[RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge](Arch.MissionComputer_Impl_Instance_SW_RadioDriver_RadioDriver) {
  ...
  def put_concrete_inputs(AttestationRequest : ISZ[Base_Types.Bits],
                          AttestationTesterResponse : ISZ[Base_Types.Bits]): Unit = {
  ...
  /** helper function to check RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver's
  ...
  def check_concrete_output(MissionCommand: ISZ[Base_Types.Bits] => B = MissionCommandParam => {T},
                            ...
                            AttestationTesterRequest: ISZ[Base_Types.Bits] => B = AttestationTesterRequestParam => {T}): Unit = {
