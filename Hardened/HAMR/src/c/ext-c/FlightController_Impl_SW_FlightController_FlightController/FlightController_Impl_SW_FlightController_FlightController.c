...
Unit HAMR_SW_FlightController_Impl_SW_FlightController_FlightController_timeTriggered_(STACK_FRAME_ONLY) {
  DeclNewStackFrame(caller, "FlightController_Impl_SW_FlightController_FlightController.c", "", "HAMR_SW_FlightController_Impl_SW_FlightController_FlightController_timeTriggered_", 0);
...
*/
  ...
  if(api_get_Alert__HAMR_SW_FlightController_Impl_SW_FlightController_FlightController(SF_LAST )){
    String Alert_str = string("Received event on Alert");
    fprintf(stderr, "FLIGHTCONTROLLER ALERT\n");
    printf("\n");
//    api_logInfo__HAMR_SW_FlightController_Impl_SW_FlightController_FlightController(SF Alert_str);
  }
}
