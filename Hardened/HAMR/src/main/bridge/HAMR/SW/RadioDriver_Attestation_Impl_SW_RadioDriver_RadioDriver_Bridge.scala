...
import art._
import HAMR._
import HAMR.SW.{RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver => component}

// This file was auto-generated.  Do not edit

@datatype class RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : RadioDriver_Attestation_Impl_Initialization_Api = {
    ...
    RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : RadioDriver_Attestation_Impl_Operational_Api = {
    ...
    RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge.EntryPoints(
      id,
...
object RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge {
  ...
  @datatype class EntryPoints(
    RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_BridgeId : Art.BridgeId,
