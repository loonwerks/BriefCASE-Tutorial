...
package HAMR.RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver
...
import HAMR._
import HAMR.SW.RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix

object RadioDriver extends App {

  val RadioDriverBridge : HAMR.SW.RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge = {
  ...
  def receiveInput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    AttestationRequest_port = RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix.AttestationRequest_Receive()

    AttestationTesterResponse_port = RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix.AttestationTesterResponse_Receive()
  }
  ...
  def sendOutput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    if(MissionCommand_port.nonEmpty) {
      RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix.MissionCommand_Send(MissionCommand_port.get)
      MissionCommand_port = noData
    }

    if(AttestationResponse_port.nonEmpty) {
      RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix.AttestationResponse_Send(AttestationResponse_port.get)
      AttestationResponse_port = noData
    }

    if(AttestationTesterRequest_port.nonEmpty) {
      RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix.AttestationTesterRequest_Send(AttestationTesterRequest_port.get)
