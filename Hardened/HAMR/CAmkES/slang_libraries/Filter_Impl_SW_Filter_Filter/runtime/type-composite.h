...
typedef enum {
  ...
  THAMR_SW_Filter_Impl_Initialization_Api = (int) 0x1471CDAC, // HAMR.SW.Filter_Impl_Initialization_Api
  THAMR_SW_Filter_Impl_Operational_Api = (int) 0x692AA288, // HAMR.SW.Filter_Impl_Operational_Api
  THAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge = (int) 0x0202F5D1, // HAMR.SW.Filter_Impl_SW_Filter_Filter_Bridge
  THAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge_EntryPoints = (int) 0x0F947337, // HAMR.SW.Filter_Impl_SW_Filter_Filter_Bridge.EntryPoints
  ...
  TNone_E227E5 = (int) 0xE227E56C, // None[HAMR.SW.Filter_Impl_Initialization_Api]
  TNone_10267D = (int) 0x10267D88, // None[HAMR.SW.Filter_Impl_Operational_Api]
  ...
  TSome_CA4FA3 = (int) 0xCA4FA323, // Some[HAMR.SW.Filter_Impl_Initialization_Api]
  TSome_73C5E1 = (int) 0x73C5E10D, // Some[HAMR.SW.Filter_Impl_Operational_Api]
