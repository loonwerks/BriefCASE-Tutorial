...
B Type__eq(void *t1, void *t2) {
  ...
  switch (type) {
    ...
    case THAMR_SW_Filter_Impl_Initialization_Api: return HAMR_SW_Filter_Impl_Initialization_Api__eq((HAMR_SW_Filter_Impl_Initialization_Api) t1, (HAMR_SW_Filter_Impl_Initialization_Api) t2);
    case THAMR_SW_Filter_Impl_Operational_Api: return HAMR_SW_Filter_Impl_Operational_Api__eq((HAMR_SW_Filter_Impl_Operational_Api) t1, (HAMR_SW_Filter_Impl_Operational_Api) t2);
    case THAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge: return HAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge__eq((HAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge) t1, (HAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge) t2);
    case THAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge_EntryPoints: return HAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge_EntryPoints__eq((HAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge_EntryPoints) t1, (HAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge_EntryPoints) t2);
    ...
    case TNone_E227E5: return None_E227E5__eq((None_E227E5) t1, (None_E227E5) t2);
    case TNone_10267D: return None_10267D__eq((None_10267D) t1, (None_10267D) t2);
    ...
    case TSome_CA4FA3: return Some_CA4FA3__eq((Some_CA4FA3) t1, (Some_CA4FA3) t2);
    case TSome_73C5E1: return Some_73C5E1__eq((Some_73C5E1) t1, (Some_73C5E1) t2);
...
void Type_cprint(void *this, B isOut) {
  ...
  switch (type) {
    ...
    case THAMR_SW_Filter_Impl_Initialization_Api: HAMR_SW_Filter_Impl_Initialization_Api_cprint((HAMR_SW_Filter_Impl_Initialization_Api) this, isOut); return;
    case THAMR_SW_Filter_Impl_Operational_Api: HAMR_SW_Filter_Impl_Operational_Api_cprint((HAMR_SW_Filter_Impl_Operational_Api) this, isOut); return;
    case THAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge: HAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge_cprint((HAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge) this, isOut); return;
    case THAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge_EntryPoints: HAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge_EntryPoints_cprint((HAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge_EntryPoints) this, isOut); return;
    ...
    case TNone_E227E5: None_E227E5_cprint((None_E227E5) this, isOut); return;
    case TNone_10267D: None_10267D_cprint((None_10267D) this, isOut); return;
    ...
    case TSome_CA4FA3: Some_CA4FA3_cprint((Some_CA4FA3) this, isOut); return;
    case TSome_73C5E1: Some_73C5E1_cprint((Some_73C5E1) this, isOut); return;
...
void Type_string_(STACK_FRAME String result, void *this) {
  ...
  switch (type) {
    ...
    case THAMR_SW_Filter_Impl_Initialization_Api: HAMR_SW_Filter_Impl_Initialization_Api_string_(CALLER result, (HAMR_SW_Filter_Impl_Initialization_Api) this); return;
    case THAMR_SW_Filter_Impl_Operational_Api: HAMR_SW_Filter_Impl_Operational_Api_string_(CALLER result, (HAMR_SW_Filter_Impl_Operational_Api) this); return;
    case THAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge: HAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge_string_(CALLER result, (HAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge) this); return;
    case THAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge_EntryPoints: HAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge_EntryPoints_string_(CALLER result, (HAMR_SW_Filter_Impl_SW_Filter_Filter_Bridge_EntryPoints) this); return;
    ...
    case TNone_E227E5: None_E227E5_string_(CALLER result, (None_E227E5) this); return;
    case TNone_10267D: None_10267D_string_(CALLER result, (None_10267D) this); return;
    ...
    case TSome_CA4FA3: Some_CA4FA3_string_(CALLER result, (Some_CA4FA3) this); return;
    case TSome_73C5E1: Some_73C5E1_string_(CALLER result, (Some_73C5E1) this); return;
