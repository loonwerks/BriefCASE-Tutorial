...
void None_E08F39_get_(STACK_FRAME HAMR_SW_AttestationManager_Impl_Initialization_Api result, None_E08F39 this) {
...
void None_AAA378_get_(STACK_FRAME HAMR_SW_AttestationManager_Impl_Operational_Api result, None_AAA378 this) {
  DeclNewStackFrame(caller, "Option.scala", "org.sireum.None", "get", 0);
