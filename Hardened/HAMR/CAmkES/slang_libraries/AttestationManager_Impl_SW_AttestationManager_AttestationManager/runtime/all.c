...
B Type__eq(void *t1, void *t2) {
  ...
  switch (type) {
    ...
    case THAMR_SW_AttestationManager_Impl_Initialization_Api: return HAMR_SW_AttestationManager_Impl_Initialization_Api__eq((HAMR_SW_AttestationManager_Impl_Initialization_Api) t1, (HAMR_SW_AttestationManager_Impl_Initialization_Api) t2);
    case THAMR_SW_AttestationManager_Impl_Operational_Api: return HAMR_SW_AttestationManager_Impl_Operational_Api__eq((HAMR_SW_AttestationManager_Impl_Operational_Api) t1, (HAMR_SW_AttestationManager_Impl_Operational_Api) t2);
    case THAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge: return HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge__eq((HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge) t1, (HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge) t2);
    case THAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints: return HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints__eq((HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints) t1, (HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints) t2);
    ...
    case TNone_E08F39: return None_E08F39__eq((None_E08F39) t1, (None_E08F39) t2);
    case TNone_AAA378: return None_AAA378__eq((None_AAA378) t1, (None_AAA378) t2);
    ...
    case TSome_88F02A: return Some_88F02A__eq((Some_88F02A) t1, (Some_88F02A) t2);
    case TSome_6D831B: return Some_6D831B__eq((Some_6D831B) t1, (Some_6D831B) t2);
...
void Type_cprint(void *this, B isOut) {
  ...
  switch (type) {
    ...
    case THAMR_SW_AttestationManager_Impl_Initialization_Api: HAMR_SW_AttestationManager_Impl_Initialization_Api_cprint((HAMR_SW_AttestationManager_Impl_Initialization_Api) this, isOut); return;
    case THAMR_SW_AttestationManager_Impl_Operational_Api: HAMR_SW_AttestationManager_Impl_Operational_Api_cprint((HAMR_SW_AttestationManager_Impl_Operational_Api) this, isOut); return;
    case THAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge: HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_cprint((HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge) this, isOut); return;
    case THAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints: HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints_cprint((HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints) this, isOut); return;
    ...
    case TNone_E08F39: None_E08F39_cprint((None_E08F39) this, isOut); return;
    case TNone_AAA378: None_AAA378_cprint((None_AAA378) this, isOut); return;
    ...
    case TSome_88F02A: Some_88F02A_cprint((Some_88F02A) this, isOut); return;
    case TSome_6D831B: Some_6D831B_cprint((Some_6D831B) this, isOut); return;
...
void Type_string_(STACK_FRAME String result, void *this) {
  ...
  switch (type) {
    ...
    case THAMR_SW_AttestationManager_Impl_Initialization_Api: HAMR_SW_AttestationManager_Impl_Initialization_Api_string_(CALLER result, (HAMR_SW_AttestationManager_Impl_Initialization_Api) this); return;
    case THAMR_SW_AttestationManager_Impl_Operational_Api: HAMR_SW_AttestationManager_Impl_Operational_Api_string_(CALLER result, (HAMR_SW_AttestationManager_Impl_Operational_Api) this); return;
    case THAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge: HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_string_(CALLER result, (HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge) this); return;
    case THAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints: HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints_string_(CALLER result, (HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints) this); return;
    ...
    case TNone_E08F39: None_E08F39_string_(CALLER result, (None_E08F39) this); return;
    case TNone_AAA378: None_AAA378_string_(CALLER result, (None_AAA378) this); return;
    ...
    case TSome_88F02A: Some_88F02A_string_(CALLER result, (Some_88F02A) this); return;
    case TSome_6D831B: Some_6D831B_string_(CALLER result, (Some_6D831B) this); return;
