...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case THAMR_SW_AttestationManager_Impl_Initialization_Api: return sizeof(struct HAMR_SW_AttestationManager_Impl_Initialization_Api); // HAMR.SW.AttestationManager_Impl_Initialization_Api
    case THAMR_SW_AttestationManager_Impl_Operational_Api: return sizeof(struct HAMR_SW_AttestationManager_Impl_Operational_Api); // HAMR.SW.AttestationManager_Impl_Operational_Api
    case THAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge: return sizeof(struct HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge); // HAMR.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge
    case THAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints: return sizeof(struct HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints); // HAMR.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge.EntryPoints
    ...
    case TNone_E08F39: return sizeof(struct None_E08F39); // None[HAMR.SW.AttestationManager_Impl_Initialization_Api]
    case TNone_AAA378: return sizeof(struct None_AAA378); // None[HAMR.SW.AttestationManager_Impl_Operational_Api]
    ...
    case TSome_88F02A: return sizeof(struct Some_88F02A); // Some[HAMR.SW.AttestationManager_Impl_Initialization_Api]
    case TSome_6D831B: return sizeof(struct Some_6D831B); // Some[HAMR.SW.AttestationManager_Impl_Operational_Api]
...
char *TYPE_string_(void *type) {
  static char *strings[] = {
    ...
    "HAMR.SW.AttestationManager_Impl_Initialization_Api",
