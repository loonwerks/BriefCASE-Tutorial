...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case THAMR_SW_RadioDriver_Attestation_Impl_Initialization_Api: return sizeof(struct HAMR_SW_RadioDriver_Attestation_Impl_Initialization_Api); // HAMR.SW.RadioDriver_Attestation_Impl_Initialization_Api
    case THAMR_SW_RadioDriver_Attestation_Impl_Operational_Api: return sizeof(struct HAMR_SW_RadioDriver_Attestation_Impl_Operational_Api); // HAMR.SW.RadioDriver_Attestation_Impl_Operational_Api
    case THAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge: return sizeof(struct HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge); // HAMR.SW.RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge
    case THAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge_EntryPoints: return sizeof(struct HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge_EntryPoints); // HAMR.SW.RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge.EntryPoints
    ...
    case TNone_C931A3: return sizeof(struct None_C931A3); // None[HAMR.SW.RadioDriver_Attestation_Impl_Initialization_Api]
    case TNone_FF6291: return sizeof(struct None_FF6291); // None[HAMR.SW.RadioDriver_Attestation_Impl_Operational_Api]
    ...
    case TSome_51939A: return sizeof(struct Some_51939A); // Some[HAMR.SW.RadioDriver_Attestation_Impl_Initialization_Api]
    case TSome_6B4FE0: return sizeof(struct Some_6B4FE0); // Some[HAMR.SW.RadioDriver_Attestation_Impl_Operational_Api]
