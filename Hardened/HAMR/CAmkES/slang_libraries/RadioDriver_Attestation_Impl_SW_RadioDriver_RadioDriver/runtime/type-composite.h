...
typedef enum {
  ...
  THAMR_SW_RadioDriver_Attestation_Impl_Initialization_Api = (int) 0x36E79E27, // HAMR.SW.RadioDriver_Attestation_Impl_Initialization_Api
  THAMR_SW_RadioDriver_Attestation_Impl_Operational_Api = (int) 0x02ECC818, // HAMR.SW.RadioDriver_Attestation_Impl_Operational_Api
  THAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge = (int) 0xD93EADC1, // HAMR.SW.RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge
  THAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge_EntryPoints = (int) 0xE420C48C, // HAMR.SW.RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge.EntryPoints
  ...
  TNone_C931A3 = (int) 0xC931A334, // None[HAMR.SW.RadioDriver_Attestation_Impl_Initialization_Api]
  TNone_FF6291 = (int) 0xFF62912B, // None[HAMR.SW.RadioDriver_Attestation_Impl_Operational_Api]
  ...
  TSome_51939A = (int) 0x51939A68, // Some[HAMR.SW.RadioDriver_Attestation_Impl_Initialization_Api]
  TSome_6B4FE0 = (int) 0x6B4FE029, // Some[HAMR.SW.RadioDriver_Attestation_Impl_Operational_Api]
