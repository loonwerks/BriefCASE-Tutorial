...
B Type__eq(void *t1, void *t2) {
  ...
  switch (type) {
    ...
    case THAMR_SW_RadioDriver_Attestation_Impl_Initialization_Api: return HAMR_SW_RadioDriver_Attestation_Impl_Initialization_Api__eq((HAMR_SW_RadioDriver_Attestation_Impl_Initialization_Api) t1, (HAMR_SW_RadioDriver_Attestation_Impl_Initialization_Api) t2);
    case THAMR_SW_RadioDriver_Attestation_Impl_Operational_Api: return HAMR_SW_RadioDriver_Attestation_Impl_Operational_Api__eq((HAMR_SW_RadioDriver_Attestation_Impl_Operational_Api) t1, (HAMR_SW_RadioDriver_Attestation_Impl_Operational_Api) t2);
    case THAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge: return HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge__eq((HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge) t1, (HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge) t2);
    case THAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge_EntryPoints: return HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge_EntryPoints__eq((HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge_EntryPoints) t1, (HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge_EntryPoints) t2);
    ...
    case TNone_C931A3: return None_C931A3__eq((None_C931A3) t1, (None_C931A3) t2);
    case TNone_FF6291: return None_FF6291__eq((None_FF6291) t1, (None_FF6291) t2);
    ...
    case TSome_51939A: return Some_51939A__eq((Some_51939A) t1, (Some_51939A) t2);
    case TSome_6B4FE0: return Some_6B4FE0__eq((Some_6B4FE0) t1, (Some_6B4FE0) t2);
...
void Type_cprint(void *this, B isOut) {
  ...
  switch (type) {
    ...
    case THAMR_SW_RadioDriver_Attestation_Impl_Initialization_Api: HAMR_SW_RadioDriver_Attestation_Impl_Initialization_Api_cprint((HAMR_SW_RadioDriver_Attestation_Impl_Initialization_Api) this, isOut); return;
    case THAMR_SW_RadioDriver_Attestation_Impl_Operational_Api: HAMR_SW_RadioDriver_Attestation_Impl_Operational_Api_cprint((HAMR_SW_RadioDriver_Attestation_Impl_Operational_Api) this, isOut); return;
    case THAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge: HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge_cprint((HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge) this, isOut); return;
    case THAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge_EntryPoints: HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge_EntryPoints_cprint((HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge_EntryPoints) this, isOut); return;
    ...
    case TNone_C931A3: None_C931A3_cprint((None_C931A3) this, isOut); return;
    case TNone_FF6291: None_FF6291_cprint((None_FF6291) this, isOut); return;
    ...
    case TSome_51939A: Some_51939A_cprint((Some_51939A) this, isOut); return;
    case TSome_6B4FE0: Some_6B4FE0_cprint((Some_6B4FE0) this, isOut); return;
...
void Type_string_(STACK_FRAME String result, void *this) {
  ...
  switch (type) {
    ...
    case THAMR_SW_RadioDriver_Attestation_Impl_Initialization_Api: HAMR_SW_RadioDriver_Attestation_Impl_Initialization_Api_string_(CALLER result, (HAMR_SW_RadioDriver_Attestation_Impl_Initialization_Api) this); return;
    case THAMR_SW_RadioDriver_Attestation_Impl_Operational_Api: HAMR_SW_RadioDriver_Attestation_Impl_Operational_Api_string_(CALLER result, (HAMR_SW_RadioDriver_Attestation_Impl_Operational_Api) this); return;
    case THAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge: HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge_string_(CALLER result, (HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge) this); return;
    case THAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge_EntryPoints: HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge_EntryPoints_string_(CALLER result, (HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge_EntryPoints) this); return;
    ...
    case TNone_C931A3: None_C931A3_string_(CALLER result, (None_C931A3) this); return;
    case TNone_FF6291: None_FF6291_string_(CALLER result, (None_FF6291) this); return;
    ...
    case TSome_51939A: Some_51939A_string_(CALLER result, (Some_51939A) this); return;
    case TSome_6B4FE0: Some_6B4FE0_string_(CALLER result, (Some_6B4FE0) this); return;
