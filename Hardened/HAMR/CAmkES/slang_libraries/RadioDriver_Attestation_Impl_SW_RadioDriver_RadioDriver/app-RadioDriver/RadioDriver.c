...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "RadioDriver.scala", "HAMR.RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver.RadioDriver", "<App>", 0);
  ...
  return (int) HAMR_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_RadioDriver_main(SF &t_args);
}