...
void None_C931A3_get_(STACK_FRAME HAMR_SW_RadioDriver_Attestation_Impl_Initialization_Api result, None_C931A3 this) {
...
void None_FF6291_get_(STACK_FRAME HAMR_SW_RadioDriver_Attestation_Impl_Operational_Api result, None_FF6291 this) {
  DeclNewStackFrame(caller, "Option.scala", "org.sireum.None", "get", 0);
