#ifndef SIREUM_TYPE_H_HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge
#define SIREUM_TYPE_H_HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge
...
typedef struct HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge *HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge;
struct HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge {
  TYPE type;
...
#define DeclNewHAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge(x) struct HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge x = { .type = THAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_Bridge }
