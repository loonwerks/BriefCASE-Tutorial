...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case THAMR_SW_AttestationGate_Impl_Initialization_Api: return sizeof(struct HAMR_SW_AttestationGate_Impl_Initialization_Api); // HAMR.SW.AttestationGate_Impl_Initialization_Api
    case THAMR_SW_AttestationGate_Impl_Operational_Api: return sizeof(struct HAMR_SW_AttestationGate_Impl_Operational_Api); // HAMR.SW.AttestationGate_Impl_Operational_Api
    case THAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge: return sizeof(struct HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge); // HAMR.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge
    case THAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge_EntryPoints: return sizeof(struct HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge_EntryPoints); // HAMR.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge.EntryPoints
    ...
    case TNone_BE0654: return sizeof(struct None_BE0654); // None[HAMR.SW.AttestationGate_Impl_Initialization_Api]
    case TNone_118401: return sizeof(struct None_118401); // None[HAMR.SW.AttestationGate_Impl_Operational_Api]
    ...
    case TSome_925053: return sizeof(struct Some_925053); // Some[HAMR.SW.AttestationGate_Impl_Initialization_Api]
    case TSome_8753F1: return sizeof(struct Some_8753F1); // Some[HAMR.SW.AttestationGate_Impl_Operational_Api]
