...
typedef enum {
  ...
  THAMR_SW_AttestationGate_Impl_Initialization_Api = (int) 0x06ED7943, // HAMR.SW.AttestationGate_Impl_Initialization_Api
  THAMR_SW_AttestationGate_Impl_Operational_Api = (int) 0xE19DEF9B, // HAMR.SW.AttestationGate_Impl_Operational_Api
  THAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge = (int) 0x65ED3CBC, // HAMR.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge
  THAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge_EntryPoints = (int) 0x78B1739D, // HAMR.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge.EntryPoints
  ...
  TNone_BE0654 = (int) 0xBE065438, // None[HAMR.SW.AttestationGate_Impl_Initialization_Api]
  TNone_118401 = (int) 0x118401F2, // None[HAMR.SW.AttestationGate_Impl_Operational_Api]
  ...
  TSome_925053 = (int) 0x9250536C, // Some[HAMR.SW.AttestationGate_Impl_Initialization_Api]
  TSome_8753F1 = (int) 0x8753F10B, // Some[HAMR.SW.AttestationGate_Impl_Operational_Api]
