...
Unit art_Art_logInfo(STACK_FRAME Z bridgeId, String msg) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(79);
    {
      ...
      HAMR_FlightController_Impl_SW_FlightController_FlightController_FlightController_logInfo(SF (String) ((String) &t_3), (String) msg);
    }
  } else {

    sfUpdateLoc(81);
    {
      HAMR_FlightController_Impl_SW_FlightController_FlightController_FlightController_logInfo(SF (String) string(""), (String) msg);
    }
  }
}
...
Unit art_Art_logDebug(STACK_FRAME Z bridgeId, String msg) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(95);
    {
      ...
      DeclNewString(t_3);
      art_Bridge_name_(SF (String) &t_3, ((art_Bridge) &t_2));
      HAMR_FlightController_Impl_SW_FlightController_FlightController_FlightController_logDebug(SF (String) ((String) &t_3), (String) msg);
    }
  } else {

    sfUpdateLoc(97);
    {
      HAMR_FlightController_Impl_SW_FlightController_FlightController_FlightController_logDebug(SF (String) string(""), (String) msg);
    }
  }
}
...
Unit art_Art_logError(STACK_FRAME Z bridgeId, String msg) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(87);
    {
      ...
      DeclNewString(t_3);
      art_Bridge_name_(SF (String) &t_3, ((art_Bridge) &t_2));
      HAMR_FlightController_Impl_SW_FlightController_FlightController_FlightController_logError(SF (String) ((String) &t_3), (String) msg);
    }
  } else {

    sfUpdateLoc(89);
    {
      HAMR_FlightController_Impl_SW_FlightController_FlightController_FlightController_logError(SF (String) string(""), (String) msg);
    }
  }
}
...
void art_Art_getValue(STACK_FRAME Option_8E9F45 result, Z portId) {
  ...
  HAMR_FlightController_Impl_SW_FlightController_FlightController_FlightController_getValue(SF (Option_8E9F45) &t_0, portId);
...
Unit art_Art_sendOutput(STACK_FRAME IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  sfUpdateLoc(70);
  {
    HAMR_FlightController_Impl_SW_FlightController_FlightController_FlightController_sendOutput(SF (IS_82ABD8) eventPortIds, (IS_82ABD8) dataPortIds);
  }
}
...
Unit art_Art_receiveInput(STACK_FRAME IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  sfUpdateLoc(58);
  {
    HAMR_FlightController_Impl_SW_FlightController_FlightController_FlightController_receiveInput(SF (IS_82ABD8) eventPortIds, (IS_82ABD8) dataPortIds);
  }
}
