#ifndef SIREUM_TYPE_H_HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge
#define SIREUM_TYPE_H_HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge
...
typedef struct HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge *HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge;
struct HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge {
  TYPE type;
...
#define DeclNewHAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge(x) struct HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge x = { .type = THAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge }
