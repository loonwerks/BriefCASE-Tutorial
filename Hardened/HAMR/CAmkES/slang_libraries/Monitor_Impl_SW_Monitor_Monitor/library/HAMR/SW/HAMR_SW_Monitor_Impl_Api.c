...
Unit HAMR_SW_Monitor_Impl_Initialization_Api_put_Output_(STACK_FRAME HAMR_SW_Monitor_Impl_Initialization_Api this, IS_C4F575 value) {
  DeclNewStackFrame(caller, "Monitor_Impl_Api.scala", "HAMR.SW.Monitor_Impl_Api", "put_Output", 0);

  sfUpdateLoc(16);
  {
    DeclNewHAMR_Base_Types_Bits_Payload(t_0);
    HAMR_Base_Types_Bits_Payload_apply(SF &t_0, (IS_C4F575) value);
    art_Art_putValue(SF HAMR_SW_Monitor_Impl_Initialization_Api_Output_Id_(this), (art_DataContent) (&t_0));
  }
}

Unit HAMR_SW_Monitor_Impl_Operational_Api_put_Output_(STACK_FRAME HAMR_SW_Monitor_Impl_Operational_Api this, IS_C4F575 value) {
  DeclNewStackFrame(caller, "Monitor_Impl_Api.scala", "HAMR.SW.Monitor_Impl_Api", "put_Output", 0);
  ...
  sfUpdateLoc(16);
  {
    DeclNewHAMR_Base_Types_Bits_Payload(t_0);
    HAMR_Base_Types_Bits_Payload_apply(SF &t_0, (IS_C4F575) value);
    art_Art_putValue(SF HAMR_SW_Monitor_Impl_Operational_Api_Output_Id_(this), (art_DataContent) (&t_0));
  }
}
