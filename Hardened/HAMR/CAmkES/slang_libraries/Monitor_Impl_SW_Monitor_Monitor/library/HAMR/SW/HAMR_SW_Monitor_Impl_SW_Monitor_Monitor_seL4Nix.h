...
Unit HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_seL4Nix_Output_Send(STACK_FRAME art_DataContent d);

Unit HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_seL4Nix_Alert_Send(STACK_FRAME art_DataContent d);

void HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_seL4Nix_Observed_Receive(STACK_FRAME Option_8E9F45 result);
