...
void None_570D44_get_(STACK_FRAME HAMR_SW_AttestationTester_Impl_Initialization_Api result, None_570D44 this) {
...
void None_3A9994_get_(STACK_FRAME HAMR_SW_AttestationTester_Impl_Operational_Api result, None_3A9994 this) {
  DeclNewStackFrame(caller, "Option.scala", "org.sireum.None", "get", 0);
