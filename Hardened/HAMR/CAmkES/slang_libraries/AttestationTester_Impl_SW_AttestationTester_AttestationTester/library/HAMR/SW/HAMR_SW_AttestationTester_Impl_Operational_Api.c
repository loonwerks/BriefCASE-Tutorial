...
B HAMR_SW_AttestationTester_Impl_Operational_Api__ne(HAMR_SW_AttestationTester_Impl_Operational_Api this, HAMR_SW_AttestationTester_Impl_Operational_Api other);
...
void HAMR_SW_AttestationTester_Impl_Operational_Api_string_(STACK_FRAME String result, HAMR_SW_AttestationTester_Impl_Operational_Api this) {
  DeclNewStackFrame(caller, "AttestationTester_Impl_Api.scala", "HAMR.SW.AttestationTester_Impl_Operational_Api", "string", 0);
...
B HAMR_SW_AttestationTester_Impl_Operational_Api__is(STACK_FRAME void* this);
HAMR_SW_AttestationTester_Impl_Operational_Api HAMR_SW_AttestationTester_Impl_Operational_Api__as(STACK_FRAME void *this);
...
void HAMR_SW_AttestationTester_Impl_Operational_Api_apply(STACK_FRAME HAMR_SW_AttestationTester_Impl_Operational_Api this, Z id, Z AttestationRequest_Id, Z AttestationResponse_Id) {
  DeclNewStackFrame(caller, "AttestationTester_Impl_Api.scala", "HAMR.SW.AttestationTester_Impl_Operational_Api", "apply", 0);
  this->id = id;
  this->AttestationRequest_Id = AttestationRequest_Id;
  this->AttestationResponse_Id = AttestationResponse_Id;
}

inline B HAMR_SW_AttestationTester_Impl_Operational_Api_get_AttestationRequest_extract_43_12_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, HAMR_SW_AttestationTester_Impl_Operational_Api this, IS_C4F575 *_v_43_41) {
...
inline B HAMR_SW_AttestationTester_Impl_Operational_Api_get_AttestationRequest_extract_44_12_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, HAMR_SW_AttestationTester_Impl_Operational_Api this, art_DataContent *_v_44_17) {
  if (!Some_D29615__is(SF t_0)) return F;
  *_v_44_17 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_0));
  return T;
}

inline B HAMR_SW_AttestationTester_Impl_Operational_Api_get_AttestationRequest_extract_47_12_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, HAMR_SW_AttestationTester_Impl_Operational_Api this) {
  return T;
}
...
void HAMR_SW_AttestationTester_Impl_Operational_Api_get_AttestationRequest_(STACK_FRAME Option_30119F result, HAMR_SW_AttestationTester_Impl_Operational_Api this) {
  DeclNewStackFrame(caller, "AttestationTester_Impl_Api.scala", "HAMR.SW.AttestationTester_Impl_Operational_Api", "get_AttestationRequest", 0);

  sfUpdateLoc(42);
  Option_30119F value;
  DeclNewOption_8E9F45(t_1);
  art_Art_getValue(SF (Option_8E9F45) &t_1, HAMR_SW_AttestationTester_Impl_Operational_Api_AttestationRequest_Id_(this));
  Option_8E9F45 t_0 = ((Option_8E9F45) &t_1);
  B match_42_47 = F;
  if (!match_42_47) {
    IS_C4F575 v_43_41;
    match_42_47 = HAMR_SW_AttestationTester_Impl_Operational_Api_get_AttestationRequest_extract_43_12_8E9F45(SF t_0, this, &v_43_41);
    if (match_42_47) {
  ...
  if (!match_42_47) {
    ...
    match_42_47 = HAMR_SW_AttestationTester_Impl_Operational_Api_get_AttestationRequest_extract_44_12_8E9F45(SF t_0, this, &v_44_17);
    if (match_42_47) {
      ...
      sfUpdateLoc(45);
      {
        ...
        art_Art_logError(SF HAMR_SW_AttestationTester_Impl_Operational_Api_id_(this), (String) ((String) &t_3));
      }
  ...
  if (!match_42_47) {
    match_42_47 = HAMR_SW_AttestationTester_Impl_Operational_Api_get_AttestationRequest_extract_47_12_8E9F45(SF t_0, this);
    if (match_42_47) {
