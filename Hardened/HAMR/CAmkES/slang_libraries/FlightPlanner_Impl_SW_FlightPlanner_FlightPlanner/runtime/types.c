...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case THAMR_SW_FlightPlanner_Impl_Initialization_Api: return sizeof(struct HAMR_SW_FlightPlanner_Impl_Initialization_Api); // HAMR.SW.FlightPlanner_Impl_Initialization_Api
    case THAMR_SW_FlightPlanner_Impl_Operational_Api: return sizeof(struct HAMR_SW_FlightPlanner_Impl_Operational_Api); // HAMR.SW.FlightPlanner_Impl_Operational_Api
    case THAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge: return sizeof(struct HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge); // HAMR.SW.FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge
    case THAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_EntryPoints: return sizeof(struct HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_EntryPoints); // HAMR.SW.FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge.EntryPoints
    ...
    case TNone_BA6ABF: return sizeof(struct None_BA6ABF); // None[HAMR.SW.FlightPlanner_Impl_Initialization_Api]
    case TNone_3EE2E0: return sizeof(struct None_3EE2E0); // None[HAMR.SW.FlightPlanner_Impl_Operational_Api]
    ...
    case TSome_9C7E56: return sizeof(struct Some_9C7E56); // Some[HAMR.SW.FlightPlanner_Impl_Initialization_Api]
    case TSome_EB994A: return sizeof(struct Some_EB994A); // Some[HAMR.SW.FlightPlanner_Impl_Operational_Api]
