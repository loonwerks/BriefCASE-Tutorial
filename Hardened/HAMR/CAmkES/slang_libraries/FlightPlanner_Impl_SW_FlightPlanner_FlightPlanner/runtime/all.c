...
B Type__eq(void *t1, void *t2) {
  ...
  switch (type) {
    ...
    case THAMR_SW_FlightPlanner_Impl_Initialization_Api: return HAMR_SW_FlightPlanner_Impl_Initialization_Api__eq((HAMR_SW_FlightPlanner_Impl_Initialization_Api) t1, (HAMR_SW_FlightPlanner_Impl_Initialization_Api) t2);
    case THAMR_SW_FlightPlanner_Impl_Operational_Api: return HAMR_SW_FlightPlanner_Impl_Operational_Api__eq((HAMR_SW_FlightPlanner_Impl_Operational_Api) t1, (HAMR_SW_FlightPlanner_Impl_Operational_Api) t2);
    case THAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge: return HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge__eq((HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge) t1, (HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge) t2);
    case THAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_EntryPoints: return HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_EntryPoints__eq((HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_EntryPoints) t1, (HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_EntryPoints) t2);
    ...
    case TNone_BA6ABF: return None_BA6ABF__eq((None_BA6ABF) t1, (None_BA6ABF) t2);
    case TNone_3EE2E0: return None_3EE2E0__eq((None_3EE2E0) t1, (None_3EE2E0) t2);
    ...
    case TSome_9C7E56: return Some_9C7E56__eq((Some_9C7E56) t1, (Some_9C7E56) t2);
    case TSome_EB994A: return Some_EB994A__eq((Some_EB994A) t1, (Some_EB994A) t2);
...
void Type_cprint(void *this, B isOut) {
  ...
  switch (type) {
    ...
    case THAMR_SW_FlightPlanner_Impl_Initialization_Api: HAMR_SW_FlightPlanner_Impl_Initialization_Api_cprint((HAMR_SW_FlightPlanner_Impl_Initialization_Api) this, isOut); return;
    case THAMR_SW_FlightPlanner_Impl_Operational_Api: HAMR_SW_FlightPlanner_Impl_Operational_Api_cprint((HAMR_SW_FlightPlanner_Impl_Operational_Api) this, isOut); return;
    case THAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge: HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_cprint((HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge) this, isOut); return;
    case THAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_EntryPoints: HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_EntryPoints_cprint((HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_EntryPoints) this, isOut); return;
    ...
    case TNone_BA6ABF: None_BA6ABF_cprint((None_BA6ABF) this, isOut); return;
    case TNone_3EE2E0: None_3EE2E0_cprint((None_3EE2E0) this, isOut); return;
    ...
    case TSome_9C7E56: Some_9C7E56_cprint((Some_9C7E56) this, isOut); return;
    case TSome_EB994A: Some_EB994A_cprint((Some_EB994A) this, isOut); return;
...
void Type_string_(STACK_FRAME String result, void *this) {
  ...
  switch (type) {
    ...
    case THAMR_SW_FlightPlanner_Impl_Initialization_Api: HAMR_SW_FlightPlanner_Impl_Initialization_Api_string_(CALLER result, (HAMR_SW_FlightPlanner_Impl_Initialization_Api) this); return;
    case THAMR_SW_FlightPlanner_Impl_Operational_Api: HAMR_SW_FlightPlanner_Impl_Operational_Api_string_(CALLER result, (HAMR_SW_FlightPlanner_Impl_Operational_Api) this); return;
    case THAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge: HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_string_(CALLER result, (HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge) this); return;
    case THAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_EntryPoints: HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_EntryPoints_string_(CALLER result, (HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_EntryPoints) this); return;
    ...
    case TNone_BA6ABF: None_BA6ABF_string_(CALLER result, (None_BA6ABF) this); return;
    case TNone_3EE2E0: None_3EE2E0_string_(CALLER result, (None_3EE2E0) this); return;
    ...
    case TSome_9C7E56: Some_9C7E56_string_(CALLER result, (Some_9C7E56) this); return;
    case TSome_EB994A: Some_EB994A_string_(CALLER result, (Some_EB994A) this); return;
