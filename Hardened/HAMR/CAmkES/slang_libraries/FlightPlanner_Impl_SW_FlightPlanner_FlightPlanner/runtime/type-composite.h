...
typedef enum {
  ...
  THAMR_SW_FlightPlanner_Impl_Initialization_Api = (int) 0xD6D96585, // HAMR.SW.FlightPlanner_Impl_Initialization_Api
  THAMR_SW_FlightPlanner_Impl_Operational_Api = (int) 0x3C3D3B31, // HAMR.SW.FlightPlanner_Impl_Operational_Api
  THAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge = (int) 0xE2E292AC, // HAMR.SW.FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge
  THAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_EntryPoints = (int) 0x9FE01697, // HAMR.SW.FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge.EntryPoints
  ...
  TNone_BA6ABF = (int) 0xBA6ABF89, // None[HAMR.SW.FlightPlanner_Impl_Initialization_Api]
  TNone_3EE2E0 = (int) 0x3EE2E072, // None[HAMR.SW.FlightPlanner_Impl_Operational_Api]
  ...
  TSome_9C7E56 = (int) 0x9C7E56CF, // Some[HAMR.SW.FlightPlanner_Impl_Initialization_Api]
  TSome_EB994A = (int) 0xEB994AC3, // Some[HAMR.SW.FlightPlanner_Impl_Operational_Api]
