...
inline B HAMR_SW_FlightPlanner_Impl_Operational_Api_get_MissionCommand_extract_43_12_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, HAMR_SW_FlightPlanner_Impl_Operational_Api this, IS_C4F575 *_v_43_41) {
...
inline B HAMR_SW_FlightPlanner_Impl_Operational_Api_get_MissionCommand_extract_44_12_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, HAMR_SW_FlightPlanner_Impl_Operational_Api this, art_DataContent *_v_44_17) {
  if (!Some_D29615__is(SF t_0)) return F;
  *_v_44_17 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_0));
  return T;
}

inline B HAMR_SW_FlightPlanner_Impl_Operational_Api_get_MissionCommand_extract_47_12_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, HAMR_SW_FlightPlanner_Impl_Operational_Api this) {
  return T;
}
