...
#include <RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_adapter.h>
#include <string.h>
#include <camkes.h>
...
Unit HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix_MissionCommand_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_RadioDriver_Attestation_Impl.c", "", "HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix_MissionCommand_Send", 0);

  sb_MissionCommand_enqueue(d);
}

// send AttestationResponse: Out EventDataPort Data_Types__AttestationResponseMsg_Impl
Unit HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix_AttestationResponse_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_RadioDriver_Attestation_Impl.c", "", "HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix_AttestationResponse_Send", 0);

  sb_AttestationResponse_enqueue(d);
}

// send AttestationTesterRequest: Out EventDataPort Data_Types__AttestationRequestMsg_Impl
Unit HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix_AttestationTesterRequest_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_RadioDriver_Attestation_Impl.c", "", "HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix_AttestationTesterRequest_Send", 0);

  sb_AttestationTesterRequest_enqueue(d);
}

// is_empty AttestationRequest: In EventDataPort
B HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix_AttestationRequest_IsEmpty(STACK_FRAME_ONLY) {
  return sb_AttestationRequest_is_empty();
}

// receive AttestationRequest: In EventDataPort union_art_DataContent
Unit HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix_AttestationRequest_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_RadioDriver_Attestation_Impl.c", "", "HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix_AttestationRequest_Receive", 0);
...
B HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix_AttestationTesterResponse_IsEmpty(STACK_FRAME_ONLY) {
  return sb_AttestationTesterResponse_is_empty();
}

// receive AttestationTesterResponse: In EventDataPort union_art_DataContent
Unit HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix_AttestationTesterResponse_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_RadioDriver_Attestation_Impl.c", "", "HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_seL4Nix_AttestationTesterResponse_Receive", 0);
...
void pre_init(void) {
  ...
  printf("Entering pre-init of RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver\n");
  ...
  HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_adapter_initialiseEntryPoint(SF_LAST);

  printf("Leaving pre-init of RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver\n");
}
...
int run(void) {
  ...
  for(;;) {
    ...
    HAMR_SW_RadioDriver_Attestation_Impl_SW_RadioDriver_RadioDriver_adapter_computeEntryPoint(SF_LAST);
    sb_self_pacer_tick_emit();
  }
  return 0;
}
