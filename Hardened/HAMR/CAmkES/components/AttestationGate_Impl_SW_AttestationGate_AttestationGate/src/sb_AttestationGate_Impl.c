...
Unit HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_seL4Nix_MissionCommand_out_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_AttestationGate_Impl.c", "", "HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_seL4Nix_MissionCommand_out_Send", 0);

  sb_MissionCommand_out_enqueue(d);
}

// is_empty MissionCommand_in: In EventDataPort
B HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_seL4Nix_MissionCommand_in_IsEmpty(STACK_FRAME_ONLY) {
  return sb_MissionCommand_in_is_empty();
}

// receive MissionCommand_in: In EventDataPort union_art_DataContent
Unit HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_seL4Nix_MissionCommand_in_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_AttestationGate_Impl.c", "", "HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_seL4Nix_MissionCommand_in_Receive", 0);
...
B HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_seL4Nix_TrustedIds_IsEmpty(STACK_FRAME_ONLY) {
  return sb_TrustedIds_is_empty();
}

// receive TrustedIds: In EventDataPort union_art_DataContent
Unit HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_seL4Nix_TrustedIds_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_AttestationGate_Impl.c", "", "HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_seL4Nix_TrustedIds_Receive", 0);
...
void pre_init(void) {
  ...
  HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_adapter_initialiseEntryPoint(SF_LAST);
...
int run(void) {
  ...
  for(;;) {
    ...
    HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_adapter_computeEntryPoint(SF_LAST);
    sb_self_pacer_tick_emit();
  }
  return 0;
}
