...
HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints entryPoints;
...
void init(STACK_FRAME_ONLY) {
  if(!initialized) {
    DeclNewStackFrame(caller, "sb_AttestationManager_Impl_ffi.c", "", "init", 0);

    entryPoints = (HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints) HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_adapter_entryPoints(SF_LAST);
    event_in_port_ids = (IS_82ABD8) HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints_eventInPortIds_(entryPoints);
    data_in_port_ids = (IS_82ABD8) HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints_dataInPortIds_(entryPoints);
    event_out_port_ids = (IS_82ABD8) HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints_eventOutPortIds_(entryPoints);
    data_out_port_ids = (IS_82ABD8) HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints_dataOutPortIds_(entryPoints);
    initialized = true;
  }
}

void ffiinitializeComponent(unsigned char *parameter, long parameterSizeBytes) {
  DeclNewStackFrame(NULL, "sb_AttestationManager_Impl_ffi.c", "", "ffiinitializeComponent", 0);
...
void checkAndReportBufferOverrun(STACK_FRAME long bytesWritten, long bufferSizeBytes) {
  ...
  DeclNewStackFrame(NULL, "sb_AttestationManager_Impl_ffi.c", "", "checkAndReportBufferOverrun", 0);
  ...
  if (bytesWritten > bufferSizeBytes) {
    ...
    api_logInfo__HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager(SF str);
  }
  #endif
}
...
void dumpBuffer(STACK_FRAME size_t numBits, U8* buffer) {
  ...
  DeclNewStackFrame(NULL, "sb_AttestationManager_Impl_ffi.c", "", "dumpBuffer", 0);
...
void ffiapi_receiveInput(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  DeclNewStackFrame(NULL, "sb_AttestationManager_Impl_ffi.c", "", "ffiapi_receiveInput", 0);
...
void ffiapi_sendOutput(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  DeclNewStackFrame(NULL, "sb_AttestationManager_Impl_ffi.c", "", "ffiapi_sendOutput", 0);
...
void ffiapi_logInfo(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes){
  DeclNewStackFrame(NULL, "sb_AttestationManager_Impl_ffi.c", "", "ffiapi_logInfo", 0);
...
void ffiapi_logDebug(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes){
  DeclNewStackFrame(NULL, "sb_AttestationManager_Impl_ffi.c", "", "ffiapi_logDebug", 0);
  ...
  api_logDebug__HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager(SF str);
} 

void ffiapi_logError(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes){
  DeclNewStackFrame(NULL, "sb_AttestationManager_Impl_ffi.c", "", "ffiapi_logError", 0);
  ...
  api_logError__HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager(SF str);
} 
...
void ffiapi_send_AttestationRequest(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  DeclNewStackFrame(NULL, "sb_AttestationManager_Impl_ffi.c", "", "ffiapi_send_AttestationRequest", 0);

  init(SF_LAST);
  api_put_AttestationRequest__HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager(SF parameterSizeBytes*8, (U8 *)parameter);
}
...
void ffiapi_get_AttestationResponse(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  DeclNewStackFrame(NULL, "sb_AttestationManager_Impl_ffi.c", "", "ffiapi_get_AttestationResponse", 0);

  init(SF_LAST);
  size_t numBits = 0;
  output[0] = api_get_AttestationResponse__HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager(SF &numBits, (U8 *)(output + 1));
...
void ffiapi_send_TrustedIds(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  DeclNewStackFrame(NULL, "sb_AttestationManager_Impl_ffi.c", "", "ffiapi_send_TrustedIds", 0);

  init(SF_LAST);
  api_put_TrustedIds__HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager(SF parameterSizeBytes*8, (U8 *)parameter);
}
