...
Unit HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_seL4Nix_AttestationRequest_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_AttestationManager_Impl.c", "", "HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_seL4Nix_AttestationRequest_Send", 0);
...
Unit HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_seL4Nix_TrustedIds_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_AttestationManager_Impl.c", "", "HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_seL4Nix_TrustedIds_Send", 0);

  sb_TrustedIds_enqueue(d);
}

// is_empty AttestationResponse: In EventDataPort
B HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_seL4Nix_AttestationResponse_IsEmpty(STACK_FRAME_ONLY) {
  return sb_AttestationResponse_is_empty();
}

// receive AttestationResponse: In EventDataPort union_art_DataContent
Unit HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_seL4Nix_AttestationResponse_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_AttestationManager_Impl.c", "", "HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_seL4Nix_AttestationResponse_Receive", 0);
...
void pre_init(void) {
  ...
  HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_adapter_initialiseEntryPoint(SF_LAST);
...
int run(void) {
  ...
  for(;;) {
    ...
    HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_adapter_computeEntryPoint(SF_LAST);
    sb_self_pacer_tick_emit();
  }
  return 0;
}
