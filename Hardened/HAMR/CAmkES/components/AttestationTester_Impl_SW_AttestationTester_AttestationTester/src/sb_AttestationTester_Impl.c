...
Unit HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_seL4Nix_AttestationResponse_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_AttestationTester_Impl.c", "", "HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_seL4Nix_AttestationResponse_Send", 0);

  sb_AttestationResponse_enqueue(d);
}

// is_empty AttestationRequest: In EventDataPort
B HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_seL4Nix_AttestationRequest_IsEmpty(STACK_FRAME_ONLY) {
  return sb_AttestationRequest_is_empty();
}

// receive AttestationRequest: In EventDataPort union_art_DataContent
Unit HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_seL4Nix_AttestationRequest_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_AttestationTester_Impl.c", "", "HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_seL4Nix_AttestationRequest_Receive", 0);
...
void pre_init(void) {
  ...
  HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_adapter_initialiseEntryPoint(SF_LAST);
...
int run(void) {
  ...
  for(;;) {
    ...
    HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_adapter_computeEntryPoint(SF_LAST);
    sb_self_pacer_tick_emit();
  }
  return 0;
}
