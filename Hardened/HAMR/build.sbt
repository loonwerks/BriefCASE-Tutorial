...
lazy val MissionComputer_Impl_Instance = slangEmbeddedProject("MissionComputer_Impl_Instance", ".")
...
val slangEmbeddedSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("HAMR.Demo"),

  mainClass in assembly := Some("HAMR.Demo"),
  assemblyJarName in assembly := "MissionComputer_Impl_Instance.jar",
...
val slangEmbeddedInspectorSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("HAMR.InspectorDemo"),
)
