...
//   $SIREUM_HOME/bin/mill HAMR.run
//
// To run the example unit tests:
//   $SIREUM_HOME/bin/mill HAMR.tests
//
// Sireum IVE:
//   First cd to the directory containing this file and execute the following:
//
//     $SIREUM_HOME/bin/sireum tools ivegen -f -m mill -n HAMR ../
//
...
//
//     $SIREUM_HOME/bin/mill -w HAMR.tests.compile
//
// Visual Studio Code:
...
object `HAMR` extends slangEmbeddedProject
...
trait SlangEmbeddedModule extends ScalaModule {
  ...
  // https://github.com/sireum/scalac-plugin/tree/4.20220221.1624956
  val sireumScalacVersion = "4.20220221.1624956"


  // refer to https://github.com/sireum/kekinian/releases to get the latest
  // Sireum Kekinian release: https://github.com/sireum/kekinian/tree/4.20220211.d12a474
  val kekinianVersion = "4.20220211.d12a474"
  ...
  override def mainClass = T { Some("HAMR.Demo") }
...
trait slangEmbeddedInspectorProject extends slangEmbeddedProject {
  ...
  override def mainClass = T { Some("HAMR.InspectorDemo") }
